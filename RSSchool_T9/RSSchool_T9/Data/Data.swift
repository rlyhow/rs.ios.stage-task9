...
struct FillingData {
    static let data: [ContentType] = [
        ...
        .gallery(Gallery(coverImage: .init("opera-0"), title: "Palais Garnier", images: .init(base: "opera", count: 5))),
        .gallery(Gallery(coverImage: .init("flowers-0"), title: "Kvetki", images: .init(base: "flowers", count: 5)))
    ]
}
